...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/TRK-Run3Winter20CosmicGS-00003-fragment.py nevts:10000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:Cosmic_step1.root'),
...
process.GlobalTag = GlobalTag(process.GlobalTag, '112X_mcRun3_2021cosmics_realistic_deco_v13', '')
