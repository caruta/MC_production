...
# with command line options: Configuration/GenProduction/python/L1T-PhaseIITDRSpring19GS-00066-fragment.py --fileout file:L1T-PhaseIITDRSpring19GS-step0.root --mc --eventcontent RAWSIM --customise SLHCUpgradeSimulations/Configuration/aging.customise_aging_1000,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --conditions 112X_mcRun4_realistic_v3 --beamspot HLLHC14TeV --step GEN,SIM --nThreads 2 --geometry Extended2026D49 --era Phase2C9 --python_filename L1T-PhaseIITDRSpring19GS-step0_cfg.py --no_exec -n 154786
...
process.maxEvents = cms.untracked.PSet(
    input = cms.untracked.int32(620000),
    #input = cms.untracked.int32(154786),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:L1T-PhaseIITDRSpring19GS-step0.root'),
